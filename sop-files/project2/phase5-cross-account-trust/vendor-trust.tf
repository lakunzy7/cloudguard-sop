...
#                          can actually act in.
#
# There is deliberately NO Condition block. That absence is the finding:
# any principal in the vendor's account, and anything the vendor's
# service is induced to do, can assume this role and receive everything
# it grants.
